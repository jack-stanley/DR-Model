function costAndQaly = doMarkov5g(npatients,util,utilSD,costsPerProc,costsPerScreen,dmInPopByAge,MortByAge,...
...
MAXSIMSIZE = 100000; % Maximum subjects within a simulation. Below that we use the actual number of subjects
