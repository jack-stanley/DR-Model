...
NSTRATEGIES = 1; % How many strategies we have. Assume strategy 1 is the base strategy
...
for i = 1:NREPEATS
    costQaly = screenSystemV1i(2,{'Montreal1','Montreal2'},[1000000,200000],[POPMIZ1,POPMIZ1],[POPHEALTHY,POPUNHEALTHY],[POPCOMPLIANT,POPCOMPLIANT],[10000,10000],[SCREENOPHTH,SCREENOPHTH],[UTILNEUTRBLIND,UTILNEUTRBLIND]);
